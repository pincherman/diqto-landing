...
.hero h1{{font-size:clamp(2em,5vw,3em);font-weight:800;color:var(--dark);letter-spacing:-0.02em;margin-bottom:16px}}
...
<nav>
  <a href="/" class="nav-logo">
    <svg viewBox="0 0 240 280" xmlns="http://www.w3.org/2000/svg">
      <path d="M10,0 L10,220 L120,220 Q200,220 200,140 L200,80 Q200,0 120,0 Z" fill="#25D366"/>
      <path d="M10,180 L-20,230 L40,220 Z" fill="#25D366"/>
      <line x1="40" y1="50" x2="155" y2="50" stroke="#fff" stroke-width="5" stroke-linecap="round"/>
      <line x1="40" y1="78" x2="165" y2="78" stroke="#fff" stroke-width="5" stroke-linecap="round"/>
      <line x1="40" y1="106" x2="140" y2="106" stroke="#fff" stroke-width="5" stroke-linecap="round"/>
      <line x1="40" y1="134" x2="110" y2="134" stroke="#fff" stroke-width="5" stroke-linecap="round"/>
      <text x="130" y="185" font-family="Arial" font-weight="bold" font-size="36" fill="#fff" opacity=".85">€</text>
    </svg>
    Diqto
  </a>
