...
<title>{title}</title>
<link rel="icon" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' rx='20' fill='%2325d366'/><text x='50' y='72' font-family='Arial' font-weight='bold' font-size='65' fill='white' text-anchor='middle'>D</text></svg>">
...
/* LOGO TYPING BUBBLE */
.logo-typing{{display:inline-flex;align-items:center;gap:10px;text-decoration:none}}
.logo-typing .bubble{{background:#25d366;border-radius:18px 18px 18px 4px;padding:8px 14px;display:flex;align-items:center;gap:4px}}
.logo-typing .bubble .dot{{width:7px;height:7px;border-radius:50%;background:#fff;animation:typingDot 1.4s infinite ease-in-out both}}
.logo-typing .bubble .dot:nth-child(2){{animation-delay:.2s}}
.logo-typing .bubble .dot:nth-child(3){{animation-delay:.4s}}
.logo-typing .text{{font-family:'Outfit',sans-serif;font-weight:800;font-size:32px;letter-spacing:-1px}}
.logo-typing .text .di{{color:#2563EB}}
.logo-typing .text .qto{{color:#1e293b}}
@keyframes typingDot{{0%,80%,100%{{transform:scale(.6);opacity:.4}}40%{{transform:scale(1);opacity:1}}}}
.logo-typing.logo-sm{{transform:scale(.7);transform-origin:left center}}
.logo-typing.logo-sm .text{{font-size:28px}}
...
<!-- NAV -->
<nav>
  <a href="/" class="nav-logo logo-typing logo-sm">
    <span class="bubble"><span class="dot"></span><span class="dot"></span><span class="dot"></span></span>
    <span class="text"><span class="di">di</span><span class="qto">qto</span></span>
  </a>
